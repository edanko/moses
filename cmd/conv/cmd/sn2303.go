...
var CmdSn2303 = &cobra.Command{
	Use:   "SN2303",
	Short: "process nc files",
...
func mainSN2303() {
	...
	files, err := filepath.Glob("in" + string(os.PathSeparator) + "*.nc")
	if err != nil {
